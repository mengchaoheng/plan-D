...
bar(y);
% axis([0 11 1 230]);
title('迭代次数统计','FontWeight','bold');xlabel('迭代次数','FontWeight','bold');ylabel('采样数','FontWeight','bold')

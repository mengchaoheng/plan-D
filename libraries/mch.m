...
%% 角度
figure,
plot(time,roll_d*r2d,'k-');hold on;
% plot(time,roll_eso,'b-');hold on;
plot(time,roll_e,'r--');hold on;
%%
...
roll_e=(data(12560:13560,1)-0.25)*0.7./100;
...
plot(time,roll_e,'b-.');
grid on;
title('正弦扰动下滚转角响应','FontWeight','bold');xlabel('t (s)','FontWeight','bold');ylabel('\phi (\circ)','FontWeight','bold')
